...
const Sidebar = ({ className }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flex flex-col bg-forest text-mint border-r border-gray-200 shadow-lg transition-all duration-300 ease-in-out z-50",
      ...
      >
        {/* Header */}
        <div
          className={cn(" p-3 flex items-center justify-between  bg-forest ")}
        >
          {!isCollapsed && (
            <>
                  ...
                  >
                    <Collapsible.Trigger asChild>
                      ...
                      >
                        ...
                        {!isCollapsed && (
                          <>
                            <span className="flex-1 text-mint">
                              {item.label}
                            </span>
                            <ChevronDown
                              className={cn(
