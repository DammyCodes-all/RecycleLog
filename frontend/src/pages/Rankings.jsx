...
const rankings = [
  { rank: 1, medal: "./First Medal.png", zone: "Zone CV", fill: "82%", status: "clean" },
  { rank: 2, medal: "/Gold Medal.png", zone: "Zone CV", fill: "82%", status: "clean" },
  { rank: 3, medal: "/Bronze Medal.png", zone: "Zone CV", fill: "82%", status: "clean" },
  { rank: 4, medal: "/Silver Medal.png", zone: "Zone CV", fill: "82%", status: "clean" },
  { rank: 5, medal: "/Silver Medal.png", zone: "Zone CV", fill: "82%", status: "clean" },
  { rank: 6, medal: "/Silver Medal.png", zone: "Zone CV", fill: "city", status: "clean" },
  { rank: 7, medal: "/Silver Medal.png", zone: "Zone CV", fill: "city", status: "raning" },
];
          ...
          <tbody className="text-gray-600">
            {rankings.map(({ rank, medal, zone, fill, status }) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-green-500 font-medium">Key metric</td>
                <td className="px-6 py-4 text-green-500 font-medium">{fill}</td>
                <td className="px-6 py-4 text-green-500 font-medium">{status}</td>
              </tr>
            ))}
          </tbody>
        </table>
